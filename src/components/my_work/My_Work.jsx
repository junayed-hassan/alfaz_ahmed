...
function My_Work() {
  return (
    <div id='work' className='myWork flex flex-col items-center justify-between lg:gap-16 md:gap-7 max-[448px]:gap-6 my-10 mx-16 max-[448px]:mx-7'>
        ...
        <div className='grid myWork-container lg:grid-cols-3 md:grid-cols-2 xl:gap-10 md:gap-6 '>
            {myWork_data.map((work,index)=>{
                return <img className='h-[250px] w-[350px] max-[448px]:mb-5  cursor-pointer box-border transition duration-300' key={index} src={work.w_img} alt="#" />
            })}
        </div>
